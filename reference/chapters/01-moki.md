...
|---|---|---|---|---|
| N1 | 49 | Try to leave 1F before talking to Auntie (companion to B2) | movement blocked / "I'd better say goodbye to Auntie first"-class redirect; player position does not cross the exit tile | `FLAG_SYS_B_DASH` and `FLAG_MAP049_EVENT001_SSA` both remain unset |
